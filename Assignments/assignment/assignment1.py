...
if __name__ == '__main__':
    ...
    df.add_polygons(['TX','USA','Spain','France','Belgium','Italy','Ireland','Scotland','Greece','Germany','Egypt','Morocco','India'])
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                for poly in gd.adjusted_poly_dict:
                    for index in gd.adjusted_poly_dict[poly]:
                        result = point_inside_polygon(x,y,index)
                        if result:
